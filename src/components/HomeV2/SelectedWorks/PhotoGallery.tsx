  ...
  return (
    <div className={cn("w-full max-w-[600px] relative")}>
      <img
        ...
        alt={title}
        className="w-auto object-cover h-full rounded-md"
      />
      <div className="absolute bottom-0 left-0 flex gap-1 w-full justify-between p-1">
        <Button
          className="p-4 md:p-[10] ring-white text-white bg-white/20 backdrop-blur-xs hover:bg-white hover:text-text-base"
